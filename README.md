# Kapu — Kapruka Gift Concierge

A full-screen, visual AI shopping agent for Kapruka.com, built for the **Kapruka Agent
Challenge**. Search a real catalog, get real delivery quotes, build a cart, and check out —
end to end, in one conversation — all powered live by the [Kapruka MCP server](https://mcp.kapruka.com).
Erica Jayasundera - Zuu Crew Assigment extension 
